...
FetchStream.prototype.runStream = function (url) {
    ...
    /************************************************************************************************************
    * 
    * initial pr for this part of the code: https://github.com/andris9/fetch/pull/3
    * also see: http://stackoverflow.com/questions/19185055/forcing-net-http-to-use-c-ares-instead-of-getaddrinfo
    *  
    * NOTE TO SELF:
    * see if this is also possible via cfg params of mikeal's request module ^^
    * 
    *************************************************************************************************************/
    if (this.options.asyncDnsLoookup) {
        var dnsCallback = (function (err, addresses) {
            ...
            // ok, the next line seems superfluous according to the node http.* docs [noted d.abromeit 2017-01-12]
